export const getFenceDetailsHtml = (FenceTypeselectedValue, NumberOfSticks, inputValuePostspace, PostSpaceUnitselectedValue, displayValues,Perimeter,area,  AreaUnitselectedValue,PerimeterUnitselectedValue) => `
  <!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
  ...
  <body>
      <div class="container">
          ...
          <ul>
          <li>Fence Type = ${FenceTypeselectedValue}</li>
