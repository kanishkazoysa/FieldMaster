...
export default function CardCollapse(props) {
    const { isCollapsed, children, contentContainerStyle, itemBorderRadius, disablePresses, containerStyle, onCollapseChanged, } = props;
    ...
    const renderItem = (item, index) => {
        return (<Animated.View key={index} onLayout={index === 0 ? onLayout : undefined} style={[
        ...
        <Container style={[contentContainerStyle, styles.card, { borderRadius: itemBorderRadius }]} onPress={() => disablePresses && onItemPress(index)}>
    ...
    return (<View style={containerStyle}>
      <View style={{ marginBottom: PEEP * 3 }}>
        ...
        {collapsed && (<TouchableOpacity onPress={open} activeOpacity={1} style={[
                styles.touchable,
                {
