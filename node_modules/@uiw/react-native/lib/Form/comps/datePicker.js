...
const FormDatePicker = ({ disabled, placeholder, contentStyle, extra, showClear, value, onChange, format = 'YYYY-MM-DD HH:mm:ss', ...attr }) => {
    ...
    const extraContent = React.useMemo(() => {
        ...
        if (value && showClear) {
            return (<Pressable onPress={() => onChange?.(undefined)} style={{ paddingRight: 3 }} disabled={disabled}>
