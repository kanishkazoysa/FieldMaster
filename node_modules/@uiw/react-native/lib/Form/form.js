...
const Form = (baseProps) => {
    const { schema, form, initialValues = {}, mode = 'default', type = 'json', watch, customComponentList = {}, changeValidate = false, cardProps = {}, containerStyle, displayType = 'column', labelStyle = {}, children, } = baseProps;
