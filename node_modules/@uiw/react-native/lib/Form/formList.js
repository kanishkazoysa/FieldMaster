...
const FormList = ({ formListValue = {
    field: '',
    type: '',
    name: '',
}, }) => {
    const { innerMethods: { store = {}, updateStore }, customComponentList, } = useContext(Context);
    ...
    const _render = (index) => {
        return items.map((v, i) => {
            ...
            const showList = items.filter((item) => !item.hide) || [];
