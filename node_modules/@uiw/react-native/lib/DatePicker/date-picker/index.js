...
const DatePicker = forwardRef((props, ref) => {
    const { title, displayType = 'modal', visible = false, onClosed, format = 'YYYY-MM-DD HH:mm:ss', labelUnit = { year: '年', month: '月', day: '日', hour: '时', minute: '分' }, mode = 'date', minDate, maxDate, value, onChange, cancelText = '取消', okText = '确定', ...restProps } = props;
    ...
    const DatePickerComp = (<DatePickerRN {...restProps} {...{ mode, value: date, minDate, maxDate, labelUnit, format }} onChange={handleChange}/>);
