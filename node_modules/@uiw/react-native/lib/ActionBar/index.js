...
function ActionBar(props) {
    ...
    const { actions = [], style, keepAbsoulte = true, height = 48, backgroundColor = theme.colors.primary_background, scroll = false, useSafeArea = true, focusIndex = 0, } = props;
    ...
    const { itemsLayouts, contentOffset, scrollContentWidth, containerWidth, gradientOpacity, gradientOpacityLeft } = state;
    ...
    const Items = useMemo(() => {
        return (<View style={[styles.container, { justifyContent: 'space-between', paddingHorizontal: scroll ? 0 : 20, ...style }]}>
...
function createStyles({ height, backgroundColor, shadowColor }) {
