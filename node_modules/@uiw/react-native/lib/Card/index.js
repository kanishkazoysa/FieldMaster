...
import { View, Platform, StyleSheet, TouchableOpacity, Animated, } from 'react-native';
import Icon from '../Icon';
import { checked } from './svg';
import CardTitle from './Card.Title';
import CardActions from './Card.Actions';
import { useTheme } from '@shopify/restyle';
const Card = ({ children, containerStyle, wrapperStyle, borderRadius, selected, onPress, onLongPress, selectedStyle = {
    ...
    return (<Container {...attributes} onPress={onPress} onLongPress={onLongPress} delayPressIn={10} activeOpacity={0.6} style={StyleSheet.flatten([
            styles.container,
